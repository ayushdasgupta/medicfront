            ...
            <div key={index} className="relative">
              ...
              {field.type === "select" ? (
                <select
                  ...
                  className="w-full p-3 bg-white/60 backdrop-blur-md border border-gray-300 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-primary"
                  required
                >
                ...
                <div className="relative">
                  <input
                    ...
                    value={field.value}
                    onChange={field.onChange}
                    className="w-full p-3 bg-white/60 backdrop-blur-md border border-gray-300 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-primary pr-10"
                    required
                  />
                  {field.type === "password" && (
                    <button
