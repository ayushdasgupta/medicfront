          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {roles.map((role) => (
              <button
                ...
                className={`p-2 rounded-lg border-2 transition-all duration-200 flex flex-col items-center ${role.color} ${
                  selectedRole === role.id ? 'ring-2 ring-offset-2 ring-blue-500' : ''
                }`}
              >
