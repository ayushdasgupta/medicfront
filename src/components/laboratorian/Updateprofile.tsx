...
import { laboratorianupdateProfile, loadlaboratorian } from "../../redux/Action/laboratorianaction";
...
const UpdateProfileLabratorian: React.FC = () => {
  ...
  const onSubmit = async (formData: ILaboratorian) => {
    try {
      await laboratorianupdateProfile(formData);
      const data =await loadlaboratorian()
...
export default UpdateProfileLabratorian;