...
import { loadPharmacist, pharmacististupdateProfile } from "../../redux/Action/pharmacistaction";
import { useAppDispatch, useAppSelector } from "../../redux/hooks/custom";
import { loadpharmacistinfo } from "../../redux/slice/pharmacistSlice";

const UpdateProfilePharmacist: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // loadPharmacist().then((data) => {
        //     dispatch(loadpharmacistinfo(data));
        //     // Reset form with pharmacist data
        //     if (data.pharmacist) {
        //         reset({
    ...
    const onSubmit = async (formData: IPharmacist) => {
        try {
            await pharmacististupdateProfile(formData);
...
export default UpdateProfilePharmacist;