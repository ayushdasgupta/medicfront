...
const newPatient=(e:React.FormEvent)=>{
  ...
  return (
    <div className="bg-white/30 backdrop-blur-md p-6 rounded-lg shadow-lg">
      ...
      <button onClick={()=>{setIsPatient(true)}} className="px-4 py-2 bg-green-500/80 hover:bg-green-500 text-white font-semibold rounded-lg shadow-md transition">Add Patient</button>
      </div>
      {/* Search Bar */}
      <div className="mb-4">
        <input
